...
-- RLS Policy: Public player usernames are viewable by anyone
-- This allows viewing basic player info without authentication for leaderboards
create policy "Public player usernames are viewable"
  on players
  for select
  using (true);
